...
const craftingTools = require('../src/crafting-tools.js');
const craftingBlocks = require('../src/crafting-blocks.js');
const craftingRecipes = require('../src/crafting-recipes.js');
